 ...
 */
export function setLocalStorageCache(key: string, value: unknown): void {
  try {
 ...
 * @returns {unknown | null} - The parsed value or null if not found or in case of an error.
 */
export function getLocalStorageCache(key: string): unknown | null {
  try {
